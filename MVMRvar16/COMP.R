...
COMP <- function(ii,E,Nvar,g,gammaY,sigmax,omega,sigmaxlow,sigmaxup,
                 bXU,sigmay,sigmaylow,sigmayup,bYU,r1,lambda,numBoot){
  ...
  # res_eills <- EILLS(fdata_all,r1=r1,meth='L-BFGS-B',lambda=lambda)
  # res_eills
  # res_eills$bound <- BOOT_EILLS(fdata_all,r1=r1,meth='L-BFGS-B',
  #                               lambda=lambda,numBoot)
  # res_eills
