...
stopCluster(cl)
save(result,file=paste0('code3_sc3_b0_g_',g,'_E_',E,'_Ecor_',Ecor,'.Rdata'))
...
stopCluster(cl)
save(result,file=paste0('code3_sc3_b0.1_g_',g,'_E_',E,'_Ecor_',Ecor,'.Rdata'))
...
stopCluster(cl)
save(result,file=paste0('code3_sc2_b0_g_',g,'_E_',E,'_Ecor_',Ecor,'.Rdata'))
...
stopCluster(cl)
save(result,file=paste0('code3_sc2_b0.1_g_',g,'_E_',E,'_Ecor_',Ecor,'.Rdata'))
...
stopCluster(cl)
save(result,file=paste0('code3_sc2_b0_g_',g,'_E_',E,'_Ecor_',Ecor,'balance.Rdata'))
...
stopCluster(cl)
save(result,file=paste0('code3_sc2_b0.1_g_',g,'_E_',E,'_Ecor_',Ecor,'balance.Rdata'))
...
stopCluster(cl)
save(result,file=paste0('code3_sc1_b0_g_',g,'_E_',E,'_Ecor_',Ecor,'.Rdata'))
...
stopCluster(cl)
save(result,file=paste0('code3_sc1_b0.1_g_',g,'_E_',E,'_Ecor_',Ecor,'.Rdata'))
