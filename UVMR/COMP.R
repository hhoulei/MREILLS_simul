...
COMP <- function(ii,E,Nvar,g,gammaY,sigmax,omega,sigmaxlow,sigmaxup,
                 bXU,sigmay,sigmaylow,sigmayup,bYU,r1,numBoot,causaleffect){
  
  cat('ii=',ii,'\n')
  
  para_list <- ParaGenerations(E,Nvar,g,gammaY,sigmax,omega,sigmaxlow,sigmaxup,
                               bXU,sigmay,sigmaylow,sigmayup,bYU,causaleffect)
  ...
  # res_eills <- EILLS(fdata_all,r1=0.1,meth='L-BFGS-B',lambda=10)
  # res_eills
