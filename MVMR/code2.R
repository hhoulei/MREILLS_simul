...
result <- foreach(ii=1:200,
  ...
  COMP(ii,E,Nvar,g,gammaY,sigmax,omega,sigmaxlow,sigmaxup,
       bXU,sigmay,sigmaylow,sigmayup,bYU,r1=r1,numBoot)
}
#stopCluster(cl)
save(result,file=paste0('code2_sc1_g_',g,'_E_',E,'.Rdata'))
...
#stopCluster(cl)
save(result,file=paste0('code2_sc2_g_',g,'_E_',E,'.Rdata'))
...
#stopCluster(cl)
save(result,file=paste0('code2_sc3_g_',g,'_E_',E,'.Rdata'))
...
#stopCluster(cl)
save(result,file=paste0('code2_sc4_g_',g,'_E_',E,'.Rdata'))
...
#stopCluster(cl)
save(result,file=paste0('code2_sc5_g_',g,'_E_',E,'.Rdata'))
...
#stopCluster(cl)
save(result,file=paste0('code2_sc6_g_',g,'_E_',E,'.Rdata'))
