...
stopCluster(cl)
save(result,file=paste0('code3_sc1_g_',g,'_E_',E,'.Rdata'))
...
stopCluster(cl)
save(result,file=paste0('code3_sc2_g_',g,'_E_',E,'.Rdata'))
...
stopCluster(cl)
save(result,file=paste0('code3_sc3_g_',g,'_E_',E,'.Rdata'))
